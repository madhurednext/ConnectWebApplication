...
var s_account = "hrblockcomconnectdev";    //***Change this for the site***

var s_hrb = s_gi(s_account)
/************************** CONFIG SECTION **************************/
/* You may add or alter any code config here. */
/* E-commerce Config */
s_hrb.currencyCode = "USD"
/* Link Tracking Config */
s_hrb.trackDownloadLinks = true;
s_hrb.trackExternalLinks = true;
s_hrb.trackInlineStats = true;
s_hrb.linkDownloadFileTypes = "exe,zip,wav,mp3,mov,mpg,avi,wmv,doc,pdf,xls,dmg";
s_hrb.linkInternalFilters = "javascript:,.";    //***Change this for the site***
s_hrb.linkLeaveQueryString = false;
s_hrb.linkTrackVars = "None";
s_hrb.linkTrackEvents = "None";
s_hrb.charSet = "";

/* WARNING: Changing the visitor namespace will cause drastic changes
to how your visitor data is collected.  Changes should only be made
when instructed to do so by your account manager.*/
s_hrb.visitorNamespace = "hrblock"

/* Plugin Config */
s_hrb.usePlugins = true
function s_hrb_doPlugins(s_hrb) {
    /* Add calls to plugins here */

    // Plugin Example: getQueryParam v2.0
    // s_hrb.campaign=s_hrb.getQueryParam('campaignId')
}
s_hrb.doPlugins = s_hrb_doPlugins
...
*/
s_hrb.getQueryParam = new Function("p", "d", "u", ""
+ "var s=this,v='',i,t;d=d?d:'';u=u?u:(s.pageURL?s.pageURL:''+s.wd.loc"
+ "ation);u=u=='f'?''+s.gtfs().location:u;while(p){i=p.indexOf(',');i="
+ "i<0?p.length:i;t=s.p_gpv(p.substring(0,i),u);if(t)v+=v?d+t:t;p=p.su"
+ "bstring(i==p.length?i:i+1)}return v");
s_hrb.p_gpv = new Function("k", "u", ""
+ "var s=this,v='',i=u.indexOf('?'),q;if(k&&i>-1){q=u.substring(i+1);v"
+ "=s.pt(q,'&','p_gvf',k)}return v");
s_hrb.p_gvf = new Function("t", "k", ""
