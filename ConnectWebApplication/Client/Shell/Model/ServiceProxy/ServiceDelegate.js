var ajaxService = (function () {
    ...
    var getCampaignGroup = function (officeId, psid, roleId, isOffficeView, resultCallBack, faultCallBack) {
        ...
        var method = 'GetCampaignGroup/' + psid + '?officeId=' + officeId + '&roleIds=' + roleId + '&isOfficeView=' + isOffficeView;
        ajaxGetJson(getSvcUrl(method, true), 'GetCampaignGroup', resultCallBack, faultCallBack);
